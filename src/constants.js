...
export const experiences = [
  {
    ...
    date: "Jun 2025 - Dec 2025 (6 months)",
    desc: "Developed and maintained RESTful APIs using Node.js and Express.js. Designed and optimized relational database schemas in MySQL and worked with MongoDB for flexible, unstructured data. Implemented token-based authentication (JWT) to secure APIs. Deployed backend services on AWS EC2, configured NGINX and PM2 for production stability. Collaborated with the front-end team to integrate and test API endpoints, and participated in debugging, performance optimization, and code reviews.",
    skills: [
      "Node.js",
      "Express.js",
      "MySQL",
...
export const education = [
  {
    id: 0,
    img: fptLogo,
    school: "FPT University HCMC, Vietnam",
    date: "Sep 2022 - Present",
    grade: "8.6 / 10 (First 5 semesters)",
    desc: "Currently pursuing a Bachelor's degree in Software Engineering at FPT University. Focusing on core computer science fundamentals and practical software development skills, including Web Development, Data Structures & Algorithms, Database Systems, and Project-Based Learning. Actively involved in hands-on projects that strengthen real-world problem-solving and full-stack development capabilities.",
